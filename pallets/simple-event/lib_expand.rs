            ...
            static CALLSITE: ::tracing::__macro_support::MacroCallsite = {
                ...
                static META: ::tracing::Metadata<'static> = {
                    ::tracing_core::metadata::Metadata::new(
                        ...
                        "simple_event",
                        ::tracing::Level::TRACE,
                        Some("pallets/simple-event/src/lib.rs"),
                        Some(16u32),
                        Some("simple_event"),
...
impl ::core::clone::Clone for Event {
    ...
    fn clone(&self) -> Event {
        match (&*self,) {
            (&Event::EmitInput(ref __self_0),) => {
                Event::EmitInput(::core::clone::Clone::clone(&(*__self_0)))
            }
        }
    }
}
...
impl ::core::cmp::PartialEq for Event {
    ...
    fn eq(&self, other: &Event) -> bool {
        match (&*self, &*other) {
            (&Event::EmitInput(ref __self_0), &Event::EmitInput(ref __arg_1_0)) => {
                (*__self_0) == (*__arg_1_0)
            }
        }
    }
...
const _: () = {
    ...
    impl _parity_scale_codec::Decode for Event {
        fn decode<__CodecInputEdqy: _parity_scale_codec::Input>(
            ...
            {
                __codec_x_edqy if __codec_x_edqy == 0usize as u8 => Ok(Event::EmitInput({
                    let __codec_res_edqy =
                        <u32 as _parity_scale_codec::Decode>::decode(__codec_input_edqy);
                    match __codec_res_edqy {
                        Err(e) => return Err(e.chain("Could not decode `Event::EmitInput.0`")),
                        Ok(__codec_res_edqy) => __codec_res_edqy,
                    }
                })),
...
impl core::fmt::Debug for Event {
    fn fmt(&self, fmt: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::EmitInput(ref a0) => fmt.debug_tuple("Event::EmitInput").field(a0).finish(),
            _ => Ok(()),
        }
    }
}
...
impl Event {
    ...
    pub fn metadata() -> &'static [::frame_support::event::EventMetadata] {
        &[::frame_support::event::EventMetadata {
            ...
            arguments: ::frame_support::event::DecodeDifferent::Encode(&["u32"]),
